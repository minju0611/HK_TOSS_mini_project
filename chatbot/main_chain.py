...
chat_history = [
    {
        ...
        "content": """
            ...
            6. 사용자가 음식 종류(중식,한식,양식,일식 등)를 물으면 반드시 get_categories_by_store_name 툴을 호출하세요.
            7. 사용자가 가게 분위기나 특징을 물으면 반드시 get_hashtags_by_store_name 툴을 호출하세요.
            8. 사용자가 맛/분위기/후기 등을 물으면 vector DB에서 리뷰 검색 후 답변하세요.
            9. 툴 사용시에 store_name이 불명확하면, 다시 사용자에게 요청하세요.

            메뉴/가게 정보는 보기 좋게 목차처럼 정리해서 보여주세요.
